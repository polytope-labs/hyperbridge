...
pub mod handler {
	...
	impl<M: ::ethers::providers::Middleware> Handler<M> {
		...
		///Calls the contract's `handlePostRequestTimeouts` (0x77dbcc39) function
		pub fn handle_post_request_timeouts(
			...
			self.0
				.method_hash([119, 219, 204, 57], (host, message))
				.expect("method not found (this should never happen)")
		}
		///Calls the contract's `handlePostRequests` (0xcd7eb047) function
		pub fn handle_post_requests(
			...
			self.0
				.method_hash([205, 126, 176, 71], (host, request))
				.expect("method not found (this should never happen)")
		}
		///Calls the contract's `handlePostResponseTimeouts` (0xf0924eaf) function
		pub fn handle_post_response_timeouts(
			...
			self.0
				.method_hash([240, 146, 78, 175], (host, message))
				.expect("method not found (this should never happen)")
		}
		///Calls the contract's `handlePostResponses` (0xe67d9a9f) function
		pub fn handle_post_responses(
			...
			self.0
				.method_hash([230, 125, 154, 159], (host, response))
				.expect("method not found (this should never happen)")
		}
	...
	/// signature `handlePostRequestTimeouts(address,((bytes,bytes,uint64,address,bytes,uint64,
	/// bytes)[],(uint256,uint256),bytes[]))` and selector `0x77dbcc39`
	#[derive(
		Clone,
		::ethers::contract::EthCall,
		::ethers::contract::EthDisplay,
	...
	#[ethcall(
		...
		abi = "handlePostRequestTimeouts(address,((bytes,bytes,uint64,address,bytes,uint64,bytes)[],(uint256,uint256),bytes[]))"
	)]
	...
	/// address,bytes,uint64,bytes),uint256,uint256)[]))` and selector `0xcd7eb047`
	#[derive(
		Clone,
		::ethers::contract::EthCall,
		::ethers::contract::EthDisplay,
	...
	#[ethcall(
		...
		abi = "handlePostRequests(address,(((uint256,uint256),bytes32[],uint256),((bytes,bytes,uint64,address,bytes,uint64,bytes),uint256,uint256)[]))"
	)]
	...
	/// signature `handlePostResponseTimeouts(address,(((bytes,bytes,uint64,address,bytes,uint64,
	/// bytes),bytes,uint64)[],(uint256,uint256),bytes[]))` and selector `0xf0924eaf`
	#[derive(
		Clone,
		::ethers::contract::EthCall,
		::ethers::contract::EthDisplay,
	...
	#[ethcall(
		...
		abi = "handlePostResponseTimeouts(address,(((bytes,bytes,uint64,address,bytes,uint64,bytes),bytes,uint64)[],(uint256,uint256),bytes[]))"
	)]
	...
	/// bytes,uint64,address,bytes,uint64,bytes),bytes,uint64),uint256,uint256)[]))` and selector
	/// `0xe67d9a9f`
	#[derive(
		Clone,
		::ethers::contract::EthCall,
	...
	#[ethcall(
		...
		abi = "handlePostResponses(address,(((uint256,uint256),bytes32[],uint256),(((bytes,bytes,uint64,address,bytes,uint64,bytes),bytes,uint64),uint256,uint256)[]))"
	)]
	...
	///`PostRequestLeaf((bytes,bytes,uint64,address,bytes,uint64,bytes),uint256,uint256)`
	#[derive(
		Clone,
		::ethers::contract::EthAbiType,
		::ethers::contract::EthAbiCodec,
	...
	///`PostRequestMessage(((uint256,uint256),bytes32[],uint256),((bytes,bytes,uint64,address,
	/// bytes,uint64,bytes),uint256,uint256)[])`
	#[derive(
		Clone,
		::ethers::contract::EthAbiType,
		::ethers::contract::EthAbiCodec,
	...
	///`PostRequestTimeoutMessage((bytes,bytes,uint64,address,bytes,uint64,bytes)[],(uint256,
	/// uint256),bytes[])`
	#[derive(
		Clone,
		::ethers::contract::EthAbiType,
	...
	///`PostResponseLeaf(((bytes,bytes,uint64,address,bytes,uint64,bytes),bytes,uint64),uint256,
	/// uint256)`
	#[derive(
		Clone,
		::ethers::contract::EthAbiType,
	...
	///`PostResponseMessage(((uint256,uint256),bytes32[],uint256),(((bytes,bytes,uint64,address,
	...
	///`PostResponseTimeoutMessage(((bytes,bytes,uint64,address,bytes,uint64,bytes),bytes,
	/// uint64)[],(uint256,uint256),bytes[])`
	#[derive(
		Clone,
		::ethers::contract::EthAbiType,
		::ethers::contract::EthAbiCodec,
