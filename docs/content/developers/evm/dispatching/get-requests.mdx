...
<Callout type="info">
For testing purposes on testnet, you can use the testnet fee token, [Hyper USD](https://sepolia.etherscan.io/address/0xA801da100bF16D07F668F4A49E1f71fc54D05177). The contract address is the same across several EVM chains. Check out the [guide](/developers/guides/testnet-fee-token) on our to get the token. 
</Callout>
