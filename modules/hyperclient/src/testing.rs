...
const OP_HOST: H160 = H160(hex!("27D689e361ab92aCab04Ea21c1B3F507A94a9DAd"));
const OP_HANDLER: H160 = H160(hex!("7037150EA7011E44488c282609870ef41ae7903d"));

const SEPOLIA_HOST: H160 = H160(hex!("92F217a5e965EAa2aD356678D537A0A9ccC0AF41"));
const SEPOLIA_HANDLER: H160 = H160(hex!("dEa00EeF80101F8E97CA710521cd2f6aBb6858A8"));

const BSC_HOST: H160 = H160(hex!("0cac3dF856aD8939955086AADd243a28f35988BE"));
const BSC_HANDLER: H160 = H160(hex!("22f0AF2B65e414228f275867a653453940D550Fc"));

const PING_MODULE: H160 = H160(hex!("3554a2260Aa37788DC8C2932A908fDa98a10Dd88"));
