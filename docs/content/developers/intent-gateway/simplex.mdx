...
<Callout type="info">
Both funding venues can be configured simultaneously. They are initialized at startup and refreshed every ~12 seconds. When planning a withdrawal, Simplex queries all configured venues and aggregates liquidity across multiple positions or pools if needed.
</Callout>
