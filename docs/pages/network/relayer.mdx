...
signer = ""
# (Optional) Maximum number of concurrent rpc requests that can be used when tracing. If not supplied will trace entire transaction batches at once.
