...
const TRACKS_DATA: [pallet_referenda::Track<u16, Balance, BlockNumber>; 6] = [
	pallet_referenda::Track {
		...
		info: pallet_referenda::TrackInfo {
			...
			min_approval: Curve::make_reciprocal(1, 7, percent(70), percent(50), percent(100)),
			min_support: Curve::make_linear(7, 7, permill(0), percent(50)),
		},
	},
	pallet_referenda::Track {
		id: 1,
		info: pallet_referenda::TrackInfo {
			...
			min_support: Curve::make_reciprocal(1, 28, percent(3), percent(2), percent(50)),
		},
	},
	pallet_referenda::Track {
		id: 2,
		info: pallet_referenda::TrackInfo {
			...
			min_enactment_period: 10 * MINUTES,
			min_approval: Curve::make_linear(17, 28, percent(70), percent(100)),
	...
	pallet_referenda::Track {
		...
		info: pallet_referenda::TrackInfo {
			...
			min_enactment_period: 3 * MINUTES,
			min_approval: Curve::make_linear(4, 7, percent(70), percent(100)),
			min_support: Curve::make_reciprocal(3, 7, percent(1), percent(0), percent(50)),
		},
	},
	pallet_referenda::Track {
		id: 4,
