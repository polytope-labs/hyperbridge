...
- **Account Key (sr25519)**: This is your main account key. It holds your reputation and is used to sign transactions. This key is what you used as the `signer` field in the relayer config.
