...
rpc_ws = "wss://hyperbridge-nexus-rpc.blockops.network"
...
# before the process should be restarted (Currently empty).
...
- `YOUR-PRIVATE-KEY`: Your Hyperbridge account's(controller) private key.
...
- All rpc_urls and beacon_rpc_url endpoints are correct and accessible.
