...
pub mod evm_host {
    ...
    impl<M: ::ethers::providers::Middleware> EvmHost<M> {
        ...
        ///Calls the contract's `setHostParamsAdmin` (0x0a653a4a) function
        pub fn set_host_params_admin(
            &self,
            params: HostParams,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([10, 101, 58, 74], (params,))
                .expect("method not found (this should never happen)")
        }
        ...
        ///Calls the contract's `updateHostParams` (0xe055c727) function
        pub fn update_host_params(
            &self,
            params: HostParams,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([224, 85, 199, 39], (params,))
                .expect("method not found (this should never happen)")
        }
    ...
    #[ethevent(
        ...
        abi = "StateCommitmentVetoed(uint256,uint256,address)"
    )]
    ...
    ///Container type for all input parameters for the `setHostParamsAdmin` function with signature `setHostParamsAdmin((uint256,uint256,address,address,address,address,uint256,uint256,address,bytes,uint256,uint256[],address[]))` and selector `0x0a653a4a`
    #[derive(Clone, ::ethers::contract::EthCall, ::ethers::contract::EthDisplay)]
    #[ethcall(
        name = "setHostParamsAdmin",
        abi = "setHostParamsAdmin((uint256,uint256,address,address,address,address,uint256,uint256,address,bytes,uint256,uint256[],address[]))"
    )]
    ...
    ///Container type for all input parameters for the `updateHostParams` function with signature `updateHostParams((uint256,uint256,address,address,address,address,uint256,uint256,address,bytes,uint256,uint256[],address[]))` and selector `0xe055c727`
    #[derive(Clone, ::ethers::contract::EthCall, ::ethers::contract::EthDisplay)]
    #[ethcall(
        name = "updateHostParams",
        abi = "updateHostParams((uint256,uint256,address,address,address,address,uint256,uint256,address,bytes,uint256,uint256[],address[]))"
    )]
    ...
    ///`HostParams(uint256,uint256,address,address,address,address,uint256,uint256,address,bytes,uint256,uint256[],address[])`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
