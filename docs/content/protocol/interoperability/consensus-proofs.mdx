...
import eclipseAttack from "./images/Untitled_eclipse_(1).svg";
import longRangeAttack from "./images/Untitled_Diagram_(4).svg";
...
The mechanism by which this consensus can be enforced has been the topic of research in distributed systems for over 2 decades, research has shown that there are two requirements for reliable consensus in distributed systems: Liveness & Safety<sup>[1]</sup>.
...
<figure>
  <img src={eclipseAttack.src} alt="Eclipse attacks are cheap to perform and have no risks associated with them" />
...
<figure>
  <img src={longRangeAttack.src} alt="Damn those time traveling validators" />
...
![Screenshot 2023-03-20 at 9.31.23 AM.png](./images/Screenshot_2023-03-20_at_9.31.23_AM.png)
...
<sup>[1]</sup> [Leslie Lamport, Generalized Consensus and Paxos](https://www.microsoft.com/en-us/research/wp-content/uploads/2016/02/tr-2005-33.pdf)

<sup>[2]</sup> [Vitalik Buterin, Proof of Stake: How I Learned to Love Weak Subjectivity](https://blog.ethereum.org/2014/11/25/proof-stake-learned-love-weak-subjectivity)

<sup>[3]</sup> [Gavin Wood, Polkadot Whitepaper](https://polkadot.network/PolkaDotPaper.pdf)

<sup>[4]</sup> [Consensys Research, Griefing Attacks](https://www.notion.so/Consensus-Proofs-091efd3982e54a9e8e21b440b3c4ab0f?pvs=21)
