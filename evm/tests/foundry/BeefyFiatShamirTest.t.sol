...
contract BeefyFiatShamirDebugDetailedTest is Test {
    ...
    function testDebugWithManualDecode() public {
        // TODO: regenerate consensus_proof.txt against solidity-merkle-trees v0.6.0
        // Fiat-Shamir proof format via beefy-prover consensus_proof_fiat_shamir().
        vm.skip(true);
        ...
        string memory proofStr = vm.readFile("tests/foundry/consensus_proof.txt");
