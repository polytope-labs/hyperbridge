...
pub mod cross_chain_messenger {
    ...
    pub static CROSSCHAINMESSENGER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static CROSSCHAINMESSENGER_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static CROSSCHAINMESSENGER_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    ///Container type for all input parameters for the `teleport` function with signature
    /// `teleport((bytes,bytes,uint64))` and selector `0x54ce464d`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for CrossChainMessengerCalls {
        fn decode(
            ...
            if let Ok(decoded) = <TeleportCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for CrossChainMessengerCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::Teleport(element) => ::ethers::core::abi::AbiEncode::encode(element),
            }
        }
    }
