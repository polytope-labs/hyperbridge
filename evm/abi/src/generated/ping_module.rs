...
pub mod ping_module {
	...
	impl<M: ::ethers::providers::Middleware> PingModule<M> {
		...
		pub fn on_get_response(
			...
			self.0
				.method_hash([167, 240, 109, 175], (response,))
				.expect("method not found (this should never happen)")
		}
