...
/**
 * @title The UnichainHost
 * @author Polytope Labs (hello@polytope.technology)
 *
 * @notice The IsmpHost and IsmpDispatcher implementation for the Unichain state machine.
 * Refer to the official ISMP specification. https://docs.hyperbridge.network/protocol/ismp
 */
contract UnichainHost is EvmHost {
    constructor(HostParams memory params) EvmHost(params) {}

    /// chainId for the Unichain mainnet
