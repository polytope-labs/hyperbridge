...
| Plan   | Bytes  | $/byte    | vs PAYG |
| ------ | ------ | --------- | ------- |
| $50    | 100 KB | $0.000500 | +67%    |
| $100   | 300 KB | $0.000333 | +11%    |
| $250   | 1 MB   | $0.000250 | -17%    |
| $1000  | 8 MB   | $0.000125 | -58%    |

Larger tiers trade upfront commitment for a steep per-byte discount — the $1000 plan is roughly 4× cheaper per byte than the $50 plan and ~58% cheaper than per-message protocol fees would be for the same payload volume.
