...
minAmount = "1000000000000000000"      # 1 BNB
maxAmount = "10000000000000000000"     # 10 BNB
...
For a 50 ETH order on Ethereum:

- Min: 1 ETH → 12 confirmations
- Max: 100 ETH → 30 confirmations
- Order: 50 ETH → ~21 confirmations (halfway between min/max)

#### Chain-Specific Recommendations

| Chain    | Block Time | Low-Value | High-Value | Reasoning                                   |
| -------- | ---------- | --------- | ---------- | ------------------------------------------- |
| Ethereum | ~12s       | 6 blocks  | 30 blocks  | Higher security, slower finality            |
| BSC      | ~3s        | 3 blocks  | 15 blocks  | Faster blocks, moderate security            |
| Polygon  | ~2s        | 5 blocks  | 25 blocks  | Very fast, but less decentralized           |
| Arbitrum | ~0.25s     | 10 blocks | 50 blocks  | Optimistic rollup, needs more confirmations |
...
[[chains]]
chainId = 137                           # Polygon
rpcUrl = "https://polygon-mainnet.g.alchemy.com/v2/YOUR_ALCHEMY_PRO_KEY"
...
minAmount = "1000000000000000000"       # 1 ETH
maxAmount = "100000000000000000000"     # 100 ETH
minConfirmations = 12                   # ~3 minutes
maxConfirmations = 30                   # ~7.5 minutes

[confirmationPolicies."137"]            # Polygon - faster blocks
minAmount = "1000000000000000000"       # 1 MATIC
maxAmount = "50000000000000000000"      # 50 MATIC
minConfirmations = 5                    # ~10 seconds
maxConfirmations = 25                   # ~50 seconds

[confirmationPolicies."42161"]          # Arbitrum - needs more confirmations
minAmount = "1000000000000000000"       # 1 ETH
maxAmount = "100000000000000000000"     # 100 ETH
minConfirmations = 10                   # ~2.5 seconds
maxConfirmations = 50                   # ~12.5 seconds
```
