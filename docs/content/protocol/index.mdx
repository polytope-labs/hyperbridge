...
- [Hash Functions](/protocol/primitives/hash-functions)
- Merkle Trees
  - [Binary Merkle Trees](/protocol/primitives/merkle-trees/binary)
  - [Merkle Mountain Ranges](/protocol/primitives/merkle-trees/mountain-range)
  - [Merkle Patricia Tries](/protocol/primitives/merkle-trees/patricia-trie)
- [Digital Signatures](/protocol/primitives/digital-signatures)
- [Polynomial Commitment Schemes](/protocol/primitives/polynomial-commitments)
- [Verkle Tries](/protocol/primitives/verkle-tries)
- [APK Proofs](/protocol/primitives/apk-proofs)
