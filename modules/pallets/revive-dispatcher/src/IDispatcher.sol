...
interface IDispatcher {
     ...
     *
     * @notice Hyperbridge collects its dispatch fees in the provided token denomination. This will typically be in stablecoins.
     *
     ...
     *
     * @notice Hyperbridge collects its dispatch fees per every byte of the outgoing message.
     *
     ...
     */
    function dispatch(
        DispatchPostResponse memory response
    ) external payable returns (bytes32 commitment);
