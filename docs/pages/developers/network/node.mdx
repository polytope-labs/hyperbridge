...
The Hyperbridge node can be obtained through a variety of ways. For only release artifacts for x86 linux environments are officially distributed. You can also build the node from source if you prefer.
