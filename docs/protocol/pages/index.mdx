...
Hyperbridge achieves trust-free interoperability by verifying and aggregating the finalized states of **all chains** on its own chain. It then uses a single proof to any chain to prove the finality of all the aggregated states. This architecture ensures that Hyperbridge is capable of scaling trust-free interoperability to all blockchains.
...
- Merkle Trees
  - [Binary Merkle Trees](/cryptography/merkle-trees/binary)
  - [Merkle Mountain Ranges](/cryptography/merkle-trees/mountain-range)
  - [Merkle Patricia Tries](/cryptography/merkle-trees/patricia-trie)
- [Digital Signatures](/cryptography/digital-signatures)
- [Polynomial Commitment Schemes](/cryptography/polynomial-commitments)
- [Verkle Tries](/cryptography/verkle-tries)
- [APK Proofs](/cryptography/apk-proofs)
...
- [GRANDPA (Polkadot)](/consensus/grandpa)
- [BEEFY (Polkadot)](/consensus/beefy)
- [Sync Committee (Ethereum)](/consensus/sync-committee)
- [Casper FFG (Ethereum)](/consensus/casper-ffg)
- [Parlia (Bsc)](/consensus/parlia)
...
- [Parachain](/state-machine/parachain)
- [Fault Dispute Games (Op Stack)](/state-machine/fault-dispute-games)
- [L2 Oracle (Op Stack)](/state-machine/l2-oracle)
- [Orbit (Arbitrum)](/state-machine/arbitrum-orbit)
