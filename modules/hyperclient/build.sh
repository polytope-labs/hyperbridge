...
wasm-pack build -t bundler -d dist/bundler --release --no-default-features --features=wasm $1
wasm-pack build -t nodejs -d dist/node --release --no-default-features --features=wasm $1
