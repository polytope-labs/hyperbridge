...
| -------- | ---------- | --------- | ---------- | ------------------------------------------- |
| Ethereum | ~12s       | 12 blocks | 30 blocks  | Highest security, slower finality (~6 min) |
...
| BSC      | ~1s        | 5 blocks  | 20 blocks  | Faster blocks, validator-based consensus    |
...
minAmount = "1000"       # 1000 USD
maxAmount = "10000"     # 10000 USD
minConfirmations = 3                   # ~36 seconds
maxConfirmations = 10                   # ~120 seconds
...
maxConfirmations = 20                   # ~20 seconds
```
