...
/**
 * @title The PolkadotHost
 * @author Polytope Labs (hello@polytope.technology)
 *
 * @notice The IsmpHost and IsmpDispatcher implementation for the Polkadot Asset Hub.
 * Refer to the official ISMP specification. https://docs.hyperbridge.network/protocol/ismp
 */
contract PolkadotHost is EvmHost {
    constructor(HostParams memory params) EvmHost(params) {}

    /// chainId for the Polkadot mainnet
    uint256 public constant CHAIN_ID = 420420419;
