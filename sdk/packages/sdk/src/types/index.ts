...
export interface SigningAccount {
	...
	/**
	 * Signs an EIP-712 typed-data payload (e.g. an EIP-2612 USDC permit for the SimplexPaymaster).
...
export interface FillOrderEstimate {
	...
	verificationGasLimit: bigint
	preVerificationGas: bigint
	/** Paymaster verification gas limit from bundler estimate, or SimplexPaymaster cap if absent. 0n when no paymaster. */
	paymasterVerificationGasLimit: bigint
	/** Paymaster postOp gas limit from bundler estimate, or SimplexPaymaster cap if absent. 0n when no paymaster. */
