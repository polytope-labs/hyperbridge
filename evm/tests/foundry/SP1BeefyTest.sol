...
contract SP1BeefyTest is Test {
    ...
    function setUp() public virtual {
        sp1 = new SP1Verifier();
        beefy = new SP1Beefy(sp1, verificationKey, 4009);
    }
    ...
    function testDecodeConsensusState() public pure {
        ...
        console.logBytes32(consensusState.currentAuthoritySet.ecdsaMerkleRoot);
        ...
        console.logBytes32(consensusState.nextAuthoritySet.ecdsaMerkleRoot);
    }
