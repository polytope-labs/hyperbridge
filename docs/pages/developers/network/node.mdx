...
We provide a variety of ways to obtain a node for running. For now we only officially distribute release artifacts for x86 linux environments.
...
```bash
wget -q --show-progress https://github.com/polytope-labs/hyperbridge/releases/download/v0.4.6/hyperbridge-x86_64-unknown-linux-gnu.tar.gz
