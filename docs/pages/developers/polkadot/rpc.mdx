# ISMP Communication: On-chain and Off-chain Interaction
...
```rust
   ...
   let params = rpc_params![pallet_ismp::mmr::LeafIndexQuery { commitment }];
...
```rust
   ...
   let at = 100;
   let params = rpc_params![at, pallet_ismp::mmr::ProofKeys::Requests(vec![commitment])];
