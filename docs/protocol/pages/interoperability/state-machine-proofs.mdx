...
There are many ways to implement a commitment scheme that supports partial reveals for blockchain state, but the most robust and widely used method is the [Merkle-Patricia trie](/cryptography/merkle-trees/patricia-trie).
