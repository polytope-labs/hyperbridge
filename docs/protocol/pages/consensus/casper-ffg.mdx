...
This allows us create a KZG commitment to this polynomial $\textmd{g}^{L(s)}$ as part of the KZG set up ceremony. Since we know that $L(x_i) - \mathcal{L}_i(x_i) = 0$, thus the prover can can compute a KZG proof for the $x_i$-th coordinate using the quotient.
...
![Screenshot 2023-05-10 at 11.52.59 AM.png](/Screenshot_2023-05-10_at_11.52.59_AM.png)
