...
pub mod evm_host {
    ...
    #[ethevent(
        ...
        abi = "GetRequestTimeoutHandled(bytes32,bytes)"
    )]
    ...
    impl ::core::fmt::Display for EvmHostEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::HostUnfrozenFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
    ...
    ///Container type for all input parameters for the `dispatch` function with signature `dispatch((bytes,uint64,bytes[],uint64,address,uint256))` and selector `0xdab0feae`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        name = "dispatch",
        abi = "dispatch((bytes,uint64,bytes[],uint64,address,uint256))"
    )]
    ...
    ///Container type for all input parameters for the `setHostParamsAdmin` function with signature `setHostParamsAdmin((uint256,uint256,address,address,address,address,uint256,uint256,address,uint256[],address[],bytes))` and selector `0x88f92ca0`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `updateHostParams` function with signature `updateHostParams((uint256,uint256,address,address,address,address,uint256,uint256,address,uint256[],address[],bytes))` and selector `0x03cb07f5`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all return fields from the `dispatch` function with signature `dispatch((bytes,uint64,bytes[],uint64,address,uint256))` and selector `0xdab0feae`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    ///`HostParams(uint256,uint256,address,address,address,address,uint256,uint256,address,uint256[],address[],bytes)`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
