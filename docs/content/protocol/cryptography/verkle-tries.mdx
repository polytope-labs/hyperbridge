...
import merklePatriciaTree from "./images/IMG_0041.jpg";
import treeGrowth from "./images/ezgif.com-gif-maker.gif";
import verkleTree from "./images/IMG_0033.jpg";
...
<figure>
  <img src={merklePatriciaTree.src} alt="A Merkle Patricia Tree, empty nodes are shaded grey." />
...
<figure>
  <img src={treeGrowth.src} alt="A Gif showing how the tree grows as leaves are inserted" />
...
<figure>
  <img src={verkleTree.src} alt="A simple verkle tree with k-arity of 256." />
