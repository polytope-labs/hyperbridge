...
**Candidacy Bond**: To register as a candidate, your controller account must have a `$BRIDGE` token of at least the minimum candidacy bond, which is 1,000,000,000,000 units (equivalent to 1 $BRIDGE).
