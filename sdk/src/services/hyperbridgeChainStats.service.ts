...
export class HyperBridgeChainStatsService {
  ...
  */
 static async getByNumberOfDeliveredMessages(
  numberOfDeliveredMessages: bigint
 ) {
  return HyperBridgeChainStats.getByNumberOfDeliveredMessages(
 ...
 static async getByNumberOfFailedDeliveries(numberOfFailedDeliveries: bigint) {
  return HyperBridgeChainStats.getByNumberOfFailedDeliveries(
 ...
 static async getByFeesPayedOutToRelayers(feesPayedOutToRelayers: bigint) {
  return HyperBridgeChainStats.getByFeesPayedOutToRelayers(
   feesPayedOutToRelayers,
   {
