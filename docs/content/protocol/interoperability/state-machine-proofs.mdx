...
import ethereumBlockHeader from "./images/header.png";
...
![Each block holds a new state.](./images/stf.svg)
...
![Consensus is denoted by the blocks marked as green.](./images/consensus.svg)
...
<figure>
  <img src={ethereumBlockHeader.src} alt="Header of an ethereum block" />
...
![ParallelSTF.svg](./images/ParallelSTF.svg)
...
This modular design was first pioneered by Dr Gavin Wood as far back as 2016 in his revolutionary whitepaper for the Polkadot network<sup>[1]</sup>. This design facilitates the provision of consensus by a blockchain to other blockchains by validating it’s state transitions through the use of state proofs.
...
<sup>[1]</sup> [G. Wood, “Polkadot: Vision for a heterogeneous multi-chain framework,” Whitepaper, 2016](https://assets.polkadot.network/Polkadot-whitepaper.pdf)

<sup>[2]</sup> [Pepyakin, Parachains Consensus Explainer](https://pep.wtf/posts/parachains-consensus/)

<sup>[3]</sup> [Alex Gluchowski, Nearly-zero cost attack scenario on Optimistic Rollup](https://ethresear.ch/t/nearly-zero-cost-attack-scenario-on-optimistic-rollup)
