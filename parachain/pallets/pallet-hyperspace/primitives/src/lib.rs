...
impl From<PacketInfo> for Packet {
    fn from(packet: PacketInfo) -> Self {
        Self {
            ...
            .unwrap_or_default(),
            data: packet.data,
            timeout_height: Height::new(packet.timeout_height.0, packet.timeout_height.1),
...
pub struct IdentifiedChannel {
    ...
    pub port_id: Vec<u8>,
    /// Protobuf encoded `ibc_rs::core::ics04_channel::connection::ChannelEnd`
...
pub struct IdentifiedConnection {
    ...
    /// Protobuf encoded `ibc_rs::core::ics03_connection::connection::ConnectionEnd`
    ...
    AccountId: From<[u8; 32]>,
{
    ...
    fn try_from(signer: ibc_rs::signer::Signer) -> Result<Self, Self::Error> {
