...
pub mod i_ismp_host {
    ...
    pub static IISMPHOST_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    ...
    impl ::ethers::contract::EthLogDecode for IIsmpHostEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = GetRequestHandledFilter::decode_log(log) {
                return Ok(IIsmpHostEvents::GetRequestHandledFilter(decoded));
            }
            ...
            if let Ok(decoded) = PostRequestHandledFilter::decode_log(log) {
                return Ok(IIsmpHostEvents::PostRequestHandledFilter(decoded));
            }
            ...
            if let Ok(decoded) = PostResponseHandledFilter::decode_log(log) {
                return Ok(IIsmpHostEvents::PostResponseHandledFilter(decoded));
            }
    ...
    impl ::core::convert::From<GetRequestHandledFilter> for IIsmpHostEvents {
    ...
    impl ::core::convert::From<PostRequestHandledFilter> for IIsmpHostEvents {
    ...
    impl ::core::convert::From<PostResponseHandledFilter> for IIsmpHostEvents {
    ...
    pub struct DaiCall;
    ///Container type for all input parameters for the `dispatch` function with signature `dispatch(((bytes,bytes,uint64,bytes,bytes,uint64,bytes,uint64),bytes),uint256)` and selector `0x0589306e`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `dispatch` function with signature `dispatch((bytes,bytes,bytes,uint64,uint64),uint256)` and selector `0x433257cb`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `dispatch` function with signature `dispatch((bytes,uint64,bytes[],uint64,uint64))` and selector `0x67bd911f`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `dispatch` function with signature `dispatch((bytes,uint64,bytes[],uint64,uint64),uint256)` and selector `0xb6427faf`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `dispatch` function with signature `dispatch(((bytes,bytes,uint64,bytes,bytes,uint64,bytes,uint64),bytes))` and selector `0xccbaa9ea`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `dispatch` function with signature `dispatch((bytes,bytes,bytes,uint64,uint64))` and selector `0xd25bcd3d`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `dispatchIncoming` function with signature `dispatchIncoming(((bytes,bytes,uint64,bytes,bytes,uint64,bytes,uint64),bytes))` and selector `0x8cf66b92`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `setHostParams` function with signature `setHostParams((uint256,uint256,uint256,uint256,uint256,uint256,address,address,address,address,address,bytes))` and selector `0xb5d999a4`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for IIsmpHostCalls {
        fn decode(
            ...
            if let Ok(decoded) = <Dispatch3Call as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::Dispatch3(decoded));
            }
            if let Ok(decoded) = <Dispatch4Call as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::Dispatch4(decoded));
            }
            if let Ok(decoded) = <Dispatch0Call as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::Dispatch0(decoded));
            }
            if let Ok(decoded) = <Dispatch5Call as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::Dispatch5(decoded));
            }
            if let Ok(decoded) = <Dispatch1Call as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::Dispatch1(decoded));
            }
            if let Ok(decoded) = <Dispatch2Call as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::ethers::core::abi::AbiEncode for IIsmpHostCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::Dispatch3(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::Dispatch4(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::Dispatch0(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::Dispatch5(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::Dispatch1(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::Dispatch2(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::core::convert::From<DaiCall> for IIsmpHostCalls {
        fn from(value: DaiCall) -> Self {
            Self::Dai(value)
        }
    }
    impl ::core::convert::From<Dispatch3Call> for IIsmpHostCalls {
        fn from(value: Dispatch3Call) -> Self {
            Self::Dispatch3(value)
        }
    }
    impl ::core::convert::From<Dispatch4Call> for IIsmpHostCalls {
        fn from(value: Dispatch4Call) -> Self {
            Self::Dispatch4(value)
        }
    }
    impl ::core::convert::From<Dispatch0Call> for IIsmpHostCalls {
        fn from(value: Dispatch0Call) -> Self {
            Self::Dispatch0(value)
        }
    }
    impl ::core::convert::From<Dispatch5Call> for IIsmpHostCalls {
        fn from(value: Dispatch5Call) -> Self {
            Self::Dispatch5(value)
        }
    }
    impl ::core::convert::From<Dispatch1Call> for IIsmpHostCalls {
        fn from(value: Dispatch1Call) -> Self {
            Self::Dispatch1(value)
        }
    }
    impl ::core::convert::From<Dispatch2Call> for IIsmpHostCalls {
    ...
    impl ::core::convert::From<SetHostParamsCall> for IIsmpHostCalls {
    ...
    impl ::core::convert::From<WithdrawCall> for IIsmpHostCalls {
    ...
    ///`HostParams(uint256,uint256,uint256,uint256,uint256,uint256,address,address,address,address,address,bytes)`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
