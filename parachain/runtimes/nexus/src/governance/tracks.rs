...
const TRACKS_DATA: [pallet_referenda::Track<u16, Balance, BlockNumber>; 6] = [
	pallet_referenda::Track {
		...
		info: pallet_referenda::TrackInfo {
			...
			min_approval: Curve::make_reciprocal(1, 7, percent(80), percent(50), percent(100)),
	...
	pallet_referenda::Track {
		...
		info: pallet_referenda::TrackInfo {
			...
			min_enactment_period: 10 * MINUTES,
			min_approval: Curve::make_linear(17, 28, percent(80), percent(100)),
	...
	pallet_referenda::Track {
		...
		info: pallet_referenda::TrackInfo {
			...
			min_enactment_period: 3 * MINUTES,
			min_approval: Curve::make_linear(4, 7, percent(80), percent(100)),
