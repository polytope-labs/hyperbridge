...
export class DispatchCall__Inputs {
  ...
  get post(): DispatchCallPostStruct {
    return changetype<DispatchCallPostStruct>(
      this._call.inputValues[0].value.toTuple(),
    );
  }
}
...
export class DispatchCallPostStruct extends ethereum.Tuple {
  get request(): DispatchCallPostRequestStruct {
    return changetype<DispatchCallPostRequestStruct>(this[0].toTuple());
  }
...
export class DispatchCallPostRequestStruct extends ethereum.Tuple {
  get source(): Bytes {
    return this[0].toBytes();
  }
...
export class Dispatch2Call__Inputs {
  ...
  get get(): Dispatch2CallGetStruct {
    return changetype<Dispatch2CallGetStruct>(
      this._call.inputValues[0].value.toTuple(),
    );
  }
}
...
export class Dispatch2CallGetStruct extends ethereum.Tuple {
  get dest(): Bytes {
    return this[0].toBytes();
  }
...
export class DispatchIncoming4Call__Inputs {
  ...
  get meta(): DispatchIncoming4CallMetaStruct {
    return changetype<DispatchIncoming4CallMetaStruct>(
      this._call.inputValues[1].value.toTuple(),
    );
  }
...
export class DispatchIncoming4CallMetaStruct extends ethereum.Tuple {
  get fee(): BigInt {
    return this[0].toBigInt();
  }
...
export class DispatchIncoming5CallResponseStruct extends ethereum.Tuple {
  ...
  get values(): Array<DispatchIncoming5CallResponseValuesStruct> {
    return this[1].toTupleArray<DispatchIncoming5CallResponseValuesStruct>();
  }
}
...
export class DispatchIncoming5CallResponseValuesStruct extends ethereum.Tuple {
  get key(): Bytes {
    return this[0].toBytes();
  }
