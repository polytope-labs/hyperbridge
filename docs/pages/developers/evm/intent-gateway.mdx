...
> **Looking to integrate?** Check out the [Intent Gateway SDK Guide](./intent-gateway-sdk.mdx) for a complete TypeScript implementation with automated fee calculation, order placement, and cancellation handling.
