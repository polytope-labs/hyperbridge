 ...
 *
 * @notice The IsmpHost and IsmpDispatcher implementation for the Tron network.
 * Refer to the official ISMP specification. https://docs.hyperbridge.network/protocol/ismp
 */
contract TronHost is EvmHost {
    constructor(HostParams memory params) EvmHost(params) {}

    /// chainId for the Tron mainnet
    uint256 public constant CHAIN_ID = 728126428;
