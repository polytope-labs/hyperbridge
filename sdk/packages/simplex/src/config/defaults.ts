...
/**
 * How long before a posting expires to replace it, when the config does not say.
 *
 * Two minutes is several attempts' worth of margin at the reconcile interval,
 * and far short of the 900 second floor the orderbook puts on a TTL.
 */
export const DEFAULT_RENEW_MARGIN_SECS = 120
