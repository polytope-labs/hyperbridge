...
export enum Chains {
	...
	POLKADOT_HUB_MAINNET = "EVM-420420419",
...
/** Polkadot Hub mainnet (chain ID 420420419) — not in viem/chains */
export const polkadotHubMainnet = defineChain({
	id: 420420419,
	name: "Polkadot Hub",
	nativeCurrency: { name: "DOT", symbol: "DOT", decimals: 10 },
	rpcUrls: {
		default: { http: ["https://hub-eth-rpc.polkadot.io"] },
	},
	blockExplorers: {
...
export const chainConfigs: Record<number, ChainConfigData> = {
	...
	420420419: {
		chainId: 420420419,
		stateMachineId: Chains.POLKADOT_HUB_MAINNET,
		viemChain: polkadotHubMainnet,
		wrappedNativeDecimals: 18,
		assets: {
			WETH: "0x0000000000000000000000000000000000000000",
			DAI: "0x0000000000000000000000000000000000000000",
		...
		defaultRpcUrl: "https://hub-eth-rpc.polkadot.io",
