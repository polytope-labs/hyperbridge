...
pub mod dispute_game_factory {
    ...
    impl<M: ::ethers::providers::Middleware> DisputeGameFactory<M> {
        ...
        pub fn game_at_index(
            ...
            M,
            (u32, u64, ::ethers::core::types::Address),
        > {
            self.0
    ...
    ///Custom Error type `NoImplementation` with signature `NoImplementation(uint32)` and selector `0x031c6de4`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    #[ethevent(
        ...
        abi = "DisputeGameCreated(address,uint32,bytes32)"
    )]
    ...
    impl ::core::fmt::Display for DisputeGameFactoryEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::InitBondUpdatedFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
    ...
    ///Container type for all input parameters for the `create` function with signature `create(uint32,bytes32,bytes)` and selector `0x82ecf2f6`
    #[derive(
        Clone,
    ...
    ///Container type for all input parameters for the `findLatestGames` function with signature `findLatestGames(uint32,uint256,uint256)` and selector `0x254bd683`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `gameImpls` function with signature `gameImpls(uint32)` and selector `0x1b685b9e`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `games` function with signature `games(uint32,bytes32,bytes)` and selector `0x5f0150cb`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `getGameUUID` function with signature `getGameUUID(uint32,bytes32,bytes)` and selector `0x96cd9720`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `initBonds` function with signature `initBonds(uint32)` and selector `0x6593dc6e`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `setImplementation` function with signature `setImplementation(uint32,address)` and selector `0x14f6b1a3`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `setInitBond` function with signature `setInitBond(uint32,uint256)` and selector `0x1e334240`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for DisputeGameFactoryCalls {
        fn decode(
            ...
            if let Ok(decoded) = <FindLatestGamesCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <InitBondsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <SetInitBondCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    ///Container type for all return fields from the `create` function with signature `create(uint32,bytes32,bytes)` and selector `0x82ecf2f6`
    #[derive(
        Clone,
    ...
    ///Container type for all return fields from the `findLatestGames` function with signature `findLatestGames(uint32,uint256,uint256)` and selector `0x254bd683`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    ///Container type for all return fields from the `gameImpls` function with signature `gameImpls(uint32)` and selector `0x1b685b9e`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    ///Container type for all return fields from the `games` function with signature `games(uint32,bytes32,bytes)` and selector `0x5f0150cb`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    ///Container type for all return fields from the `getGameUUID` function with signature `getGameUUID(uint32,bytes32,bytes)` and selector `0x96cd9720`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    ///Container type for all return fields from the `initBonds` function with signature `initBonds(uint32)` and selector `0x6593dc6e`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
