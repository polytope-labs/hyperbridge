...
/**
 * Signs an EIP-2612 permit for a token that supports it.
 *
 * Used by both Circle Paymaster (USDC) and Simplex Paymaster (USDC/USDT)
 * to grant a spending allowance via off-chain signature rather than an
