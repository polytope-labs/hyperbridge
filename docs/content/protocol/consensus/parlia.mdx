---
title: Parlia (Bsc)
description: The Binance Smart Chain (BSC) utilizes a custom BFT consensus protocol based on Delegated Proof of Staked to achieve fast Finality. This protocol combines elements of DPos and PoA. As a BFT protocol it employs slashing of staked funds to disincentivize malicious behaviour.
---
