...
Pallet Ismp efficiently stores commitments for requests and responses. It leverages two primary data structures:
...
* `Optional Merkle Mountain Range Tree (MMR Tree)`: When integrated with Hyperbridge, this additional tree provides even smaller proofs and more economical verification on the Ethereum Virtual Machine (EVM). This translates to lower gas fees for users sending messages to EVM chains.
...
### Challenge: Off-Chain Database and Chain Reorgs
