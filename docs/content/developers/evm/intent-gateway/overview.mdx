...
the receipt and chain state, and may rebroadcast the identical operation. Definitive first-send rejection
permits fallback; an uncertain earlier send blocks another distinct bid until its outcome is established.
