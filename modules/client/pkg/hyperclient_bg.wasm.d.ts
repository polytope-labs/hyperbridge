...
export function request_status_stream(a: number, b: number): number;
...
export function __wbg_get_jspost_height(a: number): number;
export function __wbg_set_jspost_height(a: number, b: number): void;
...
export function wasm_bindgen__convert__closures__invoke0_mut__h45014c170f4f0a69(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h17bcd9068017edfb(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hfd7f7e7779f39d23(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h12bccd628d3727fa(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6db5424a3639ca06(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h0d0964c900480c3d(a: number, b: number, c: number, d: number): void;
