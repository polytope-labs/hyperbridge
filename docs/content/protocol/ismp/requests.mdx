...
import requestCommitment from "./images/request.commitment.svg";
import incomingRequest from "./images/incoming.request.svg";
...
<figure>
  <img src={requestCommitment.src} alt="The flow of an outgoing request" />
  <figcaption>The flow of an outgoing request</figcaption>
</figure>
<br />
<figure>
  <img src={incomingRequest.src} alt="The flow of an incoming request" />
