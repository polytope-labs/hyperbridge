 ...
 * @returns {string}
 */
module.exports.generate_root_with_proof = function(calldata_bytes, tree_size) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {boolean}
 */
module.exports.verify_proof = function(root_hex, proof_hex, mmr_size, leaf_position, calldata_bytes) {
