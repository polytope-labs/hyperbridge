...
by output value normalized to the original input amounts, confirms each
...
blocks another distinct bid until its outcome is established. Manual selection remains available. Normalized ranking amounts describe prices; actual signed quotes
determine funding and deliverable liquidity.
