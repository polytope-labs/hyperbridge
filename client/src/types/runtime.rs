...
pub mod api {
    ...
    pub type Event = runtime_types::gargantuan_runtime::RuntimeEvent;
    #[doc = r" The outer extrinsic enum."]
    pub type Call = runtime_types::gargantuan_runtime::RuntimeCall;
    #[doc = r" The outer error enum representing the DispatchError's Module variant."]
    pub type Error = runtime_types::gargantuan_runtime::RuntimeError;
        ...
        pub mod transaction_payment_call_api {
            ...
            impl TransactionPaymentCallApi {
                ...
                pub fn query_call_info(
                    &self,
                    call: runtime_types::gargantuan_runtime::RuntimeCall,
                    len: ::core::primitive::u32,
                ) -> ::subxt::runtime_api::Payload<
                    types::QueryCallInfo,
                    runtime_types::pallet_transaction_payment::types::RuntimeDispatchInfo<
            ...
            pub mod types {
                ...
                pub struct QueryCallInfo {
                    pub call: runtime_types::gargantuan_runtime::RuntimeCall,
                    pub len: ::core::primitive::u32,
                }
                #[derive(
                    :: subxt :: ext :: codec :: Decode,
            ...
            impl StorageApi {
                ...
                pub fn events(
                    ...
                    ::std::vec::Vec<
                        runtime_types::frame_system::EventRecord<
                            runtime_types::gargantuan_runtime::RuntimeEvent,
                            ::subxt::utils::H256,
                        >,
                    >,
                    ::subxt::storage::address::Yes,
                ...
                > {
                    ::subxt::storage::address::Address::new_static(
                        ...
                        vec![],
                        [
                            72u8, 129u8, 130u8, 71u8, 127u8, 138u8, 141u8, 89u8, 73u8, 158u8,
                            165u8, 130u8, 201u8, 42u8, 189u8, 53u8, 177u8, 162u8, 90u8, 238u8,
                            227u8, 39u8, 255u8, 118u8, 106u8, 127u8, 5u8, 114u8, 58u8, 152u8, 41u8,
                            221u8,
                        ],
                    )
                }
    ...
    pub mod parachain_system {
        ...
        pub mod storage {
            ...
            impl StorageApi {
                ...
                #[doc = " latest the latest HRMP watermark. Used for limiting the acceptance of new blocks with"]
                ...
                pub fn holds_iter(
                    ...
                    runtime_types::bounded_collections::bounded_vec::BoundedVec<
                        runtime_types::pallet_balances::types::IdAmount<
                            runtime_types::gargantuan_runtime::HoldReason,
                            ::core::primitive::u128,
                        >,
                    >,
                    (),
    ...
    pub mod session {
        ...
        pub mod calls {
            ...
            pub mod types {
                ...
                #[encode_as_type(crate_path = ":: subxt :: ext :: scale_encode")]
                pub struct SetKeys {
                    pub keys: runtime_types::gargantuan_runtime::SessionKeys,
            ...
            impl TransactionApi {
                ...
                pub fn set_keys(
                    &self,
                    keys: runtime_types::gargantuan_runtime::SessionKeys,
        ...
        pub mod storage {
            ...
            impl StorageApi {
                ...
                pub fn queued_keys(
                    ...
                    ::std::vec::Vec<(
                        ::subxt::utils::AccountId32,
                        runtime_types::gargantuan_runtime::SessionKeys,
                    )>,
                    ::subxt::storage::address::Yes,
                    ::subxt::storage::address::Yes,
                    (),
    ...
    pub mod sudo {
        ...
        pub mod calls {
            ...
            pub mod types {
                ...
                #[encode_as_type(crate_path = ":: subxt :: ext :: scale_encode")]
                pub struct Sudo {
                    pub call: ::std::boxed::Box<runtime_types::gargantuan_runtime::RuntimeCall>,
                }
    ...
    pub mod cumulus_xcm {
        ...
        pub mod events {
            ...
            pub struct ExecutedDownward(
                ...
                pub runtime_types::staging_xcm::v3::traits::Outcome,
            );
            ...
            pub mod pallet {
                ...
                pub enum Event {
                    ...
                    ExecutedDownward {
                        ...
                        outcome: runtime_types::staging_xcm::v3::traits::Outcome,
                    },
                    #[codec(index = 3)]
                    #[doc = "The weight limit for handling downward messages was reached."]
                    WeightExhausted {
            ...
            pub mod pallet {
                ...
                pub enum Event {
                    ...
                    ExecutedDownward(
                        ...
                        runtime_types::staging_xcm::v3::traits::Outcome,
                    ),
                }
            }
        }
        ...
        pub mod pallet_sudo {
            ...
            pub mod pallet {
                ...
                pub enum Call {
                    #[codec(index = 0)]
                    #[doc = "See [`Pallet::sudo`]."]
                    sudo { call: ::std::boxed::Box<runtime_types::gargantuan_runtime::RuntimeCall> },
                    #[codec(index = 1)]
                    #[doc = "See [`Pallet::sudo_unchecked_weight`]."]
                    sudo_unchecked_weight {
                        call: ::std::boxed::Box<runtime_types::gargantuan_runtime::RuntimeCall>,
                        weight: runtime_types::sp_weights::weight_v2::Weight,
                    },
                    #[codec(index = 2)]
                    #[doc = "See [`Pallet::set_key`]."]
