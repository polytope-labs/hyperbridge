...
impl<T: frame_system::Config> ismp_parachain::WeightInfo for WeightInfo<T> {
	...
	/// Storage: `IsmpParachain::CurrentRelayChainStateRoots` (r:1 w:0)
	...
	/// Storage: `Ismp::BoundedStateCommitments` (r:1 w:1)
	/// Proof: `Ismp::BoundedStateCommitments` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `Ismp::StateCommitmentsCount` (r:1 w:1)
	/// Proof: `Ismp::StateCommitmentsCount` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `Ismp::BoundedStateMachineUpdateTime` (r:0 w:1)
	/// Proof: `Ismp::BoundedStateMachineUpdateTime` (`max_values`: None, `max_size`: None, mode: `Measured`)
	...
	fn update_parachain_consensus() -> Weight {
		...
		//  Measured:  `910`
		//  Estimated: `5964`
		// Minimum execution time: 133_453_000 picoseconds.
		Weight::from_parts(135_306_000, 0)
