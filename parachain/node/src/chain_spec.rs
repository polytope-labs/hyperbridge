...
pub fn sagittarius_development_config(id: u32) -> ChainSpec<sagittarius_runtime::RuntimeGenesisConfig> {
    // Give your base currency a unit name and decimal places
    let mut properties = sc_chain_spec::Properties::new();
    properties.insert("tokenSymbol".into(), "DEV".into());
    properties.insert("tokenDecimals".into(), 12.into());
    ...
    ChainSpec::builder(
        sagittarius_runtime::WASM_BINARY.expect("WASM binary was not built, please build it!"),
        Extensions {
            relay_chain: "rococo-local".into(),
            // You MUST set this to the correct network!
            para_id: id,
        ...
        .with_name("sagittarius_runtime-dev")
        .with_id("sagittarius_runtime")
        .with_chain_type(ChainType::Development)
        .with_genesis_config_patch(testnet_genesis(
            // initial collators.
            vec![
