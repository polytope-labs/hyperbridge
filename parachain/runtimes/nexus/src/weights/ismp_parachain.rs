...
impl<T: frame_system::Config> ismp_parachain::WeightInfo for WeightInfo<T> {
	...
	/// Proof: `IsmpParachain::Parachains` (`max_values`: None, `max_size`: Some(4), added: 2479, mode: `MaxEncodedLen`)
	...
	fn add_parachain(n: u32, ) -> Weight {
		...
		Weight::from_parts(7_150_139, 0)
			.saturating_add(Weight::from_parts(0, 1489))
			// Standard Error: 1_662
			.saturating_add(Weight::from_parts(3_477_935, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(n.into())))
	}
	/// Storage: `IsmpParachain::Parachains` (r:0 w:5)
	/// Proof: `IsmpParachain::Parachains` (`max_values`: None, `max_size`: Some(4), added: 2479, mode: `MaxEncodedLen`)
	/// Storage: `IsmpParachain::SlotDurations` (r:0 w:5)
	/// Proof: `IsmpParachain::SlotDurations` (`max_values`: None, `max_size`: Some(12), added: 2487, mode: `MaxEncodedLen`)
	/// The range of component `n` is `[1, 100]`.
	fn remove_parachain(n: u32, ) -> Weight {
		...
		Weight::from_parts(16_901_178, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 345
			.saturating_add(Weight::from_parts(14_734, 0).saturating_mul(n.into()))
	...
	/// Storage: `IsmpParachain::KnownRelayHeights` (r:1 w:1)
	/// Proof: `IsmpParachain::KnownRelayHeights` (`max_values`: Some(1), `max_size`: Some(1026), added: 1521, mode: `MaxEncodedLen`)
	/// Storage: `IsmpParachain::CurrentRelayChainStateRoots` (r:2 w:2)
	...
	fn on_finalize_bound_relay_state_commitments() -> Weight {
		...
		//  Measured:  `2436`
		//  Estimated: `6044`
		// Minimum execution time: 38_092_000 picoseconds.
